...
【2.13下午 继续调环境，timestep=240, uav_num=6, 每个无人机update_num=5, 每个poi amount=5】
...
mkdir -p ${nohup_dir}
for 
nohup python -u main_DPPO.py --group ${group} --max-episode-step 240 --uav-num 6 --device cuda:4 >> ${nohup_dir}/0213.log 2>&1 &
```
