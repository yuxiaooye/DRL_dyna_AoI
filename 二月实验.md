...
for update_num in 10 5;
do
for user_data_amount in 1 5;
do
nohup python -u main_DPPO.py --group ${group} --dyna_level 4 --update_num ${update_num} --user_data_amount ${user_data_amount} --device cuda:4 >> ${nohup_dir}/0214.log 2>&1 &
nohup python -u main_DPPO.py --group ${group} --algo G2ANet --dyna_level 4 --update_num ${update_num} --user_data_amount ${user_data_amount} --device cuda:4 >> ${nohup_dir}/0214.log 2>&1 &
done
done
```
